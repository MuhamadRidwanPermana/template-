...
function DashboardCard08() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white shadow-lg rounded-3xl border p-5 w-full h-full">
      <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center">
        <h2 className="font-bold text-2xl">Grafik Penjualan Tahun 2023</h2>
      </header>
